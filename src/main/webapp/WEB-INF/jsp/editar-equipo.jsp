...
<html>
    ...
    <body>
        <div class="uk-container uk-container-expand">
            <h1 class="uk-text-primary uk-margin-top uk-margin-bottom">Editar equipo</h1>
            ...
            <form:form action="editar-equipo.htm"  commandName="equipo" modelAttribute="equipo" cssClass="uk-form-stacked">
                <div class="uk-margin">
